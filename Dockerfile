...
LABEL konflux.additional-tags="0.12.0"

FROM base AS builder
COPY --from=ghcr.io/astral-sh/uv:0.10.3@sha256:7a88d4c4e6f44200575000638453a5a381db0ae31ad5c3a51b14f8687c9d93a3 /uv /bin/uv
