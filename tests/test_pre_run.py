...
@pytest.mark.parametrize(
    ...
    [
        ...
        (True, State.SWITCHOVER_COMPLETED, 0),
        (False, State.SWITCHOVER_COMPLETED, 0),
        (True, State.DELETING_SOURCE_DB_INSTANCES, 0),
        (False, State.DELETING_SOURCE_DB_INSTANCES, 0),
        (True, State.SOURCE_DB_INSTANCES_DELETED, 0),
        (False, State.SOURCE_DB_INSTANCES_DELETED, 0),
        (True, State.DELETING, 0),
        (False, State.DELETING, 0),
        (True, State.NO_OP, 0),
        (False, State.NO_OP, 0),
    ],
)
